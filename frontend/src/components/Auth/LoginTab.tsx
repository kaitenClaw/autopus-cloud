    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-2 bg-[var(--surface-1)] text-[var(--text-muted)] text-xs">Or continue with</span>
        </div>
      </div>
      ...
      <button
        ...
        className="w-full bg-white text-black p-2.5 rounded-lg font-bold transition hover:bg-zinc-100 flex items-center justify-center gap-2"
        disabled={isLoading}
      >
